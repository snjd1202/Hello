...
public class Test05 {
	/*
	 	...
	 	Scanner 에서 문자를 추출해주는 함수는 존재하지 않는다.
	 	따라서 문자열로 추출한 후에 첫 번째 자리의 문자만 추출해서 사용해야 한다.
	 	
	 		charAt(위치값) ==> 문자열의 해당 위치값에 들어있는 문자를 추출해주는 함수
	 			참고]
	...
	public static void main(String[] args) {
		...
		System.out.println("str의 첫 번째 문자 : " + ch);
